<div align="center" width="100">
  <img src="https://capsule-render.vercel.app/api?color=0:1408d0,50:0860d0,100:08c4d0&height=250&section=header&text=Hola%20yo%20soy%20Luis%20Santiago%20(Luis19870315)&fontSize=30&type=waving&fontColor=fefefe&&animation=fadeIn"
  alt="header"/>

<p align="center">
  <a href="https://github.com/DenverCoder1/readme-typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Time+New+Roman&color=cyan&size=25&center=true&vCenter=true&width=600&height=100&lines=Bienvenidos+a+mi+perfil+Github;SSoy+un+profesional+en+ciencia+de+Datos+junior;Computer+Science+Student;Con+formacion+tecnica+en+Machine+Learnining;analisis+exploratorio+de+datos+(EDA);Manejo+Python+,+SQL+y;Ciencia+de+Datos;cuento+con+con+experiencia+en;estructurar+información;identificar+tendencias+y;construir+modelos+que+apoyan;decisiones+estratégicas;Tengo+experiencia+en+atencion+a+clientes;I+have+experience+in+customer+service;Soy+ademas+abogado+profesional;I+am+also+a+professional+lawyer;Me+encanta+aprender+cosas+nuevas;Love+to+learn+new+stuffs;Me+gustaria+conocerte...&hearts;++;I+would+like+to+meet+you...&hearts;++"></a>
</p>
...
🌱 I’m currently learning --> **Actualmente me encuentro fortaleciendo mis habilidades en programación y análisis de datos, con el objetivo de consolidarme profesionalmente como Científico de Datos y aportar soluciones basadas en evidencia y modelos analíticos** <img align="right" style="width:16rem; height:auto" src="https://raw.githubusercontent.com/Elanza-48/Elanza-48/41a4790484e268102dfdab2b7c59d440d3ffafab/resources/img/geek.gif"/>
